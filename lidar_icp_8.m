function [lidar_times, xTransform, yTransform, angleTransform, xOverTime, yOverTime, angleOverTime, rmseOverTime] = lidar_icp_8(logfilename, time1, time2)
...
for i=2:1:length(decoded_data)
    ...
    rotationMatrix = [cos(0), -sin(0), 0, 0;
                       sin(0), cos(0), 0, 0;
                       0, 0, 1, 0;
    ...
    [tform2, ~, rmse2] = pcregistericp(createPointCloud(decoded_data{1}), ptCloud2, MaxIterations=100000,Tolerance=[0.00001, 0.00001],InitialTransform=rigidTransformInitial);
    rot = tform2.R;
    eulerAnglesRad = rotm2eul(rot);
    eulerAnglesDeg = rad2deg(eulerAnglesRad);
